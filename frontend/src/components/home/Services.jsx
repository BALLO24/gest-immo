            ...
            {[
              {
                ...
                a: "Créez un compte agence gratuitement, patientez le temps de la validation par un administrateur, puis publiez vos biens avec photos et détails depuis votre tableau de bord.",
              },
              {
                q: "Les agences sont-elles vérifiées ?",
                a: "Oui, chaque agence est validée par un administrateur avant de pouvoir publier — c'est ce contrôle en amont qui garantit le sérieux des annonceurs présents sur la plateforme.",
              },
              {
