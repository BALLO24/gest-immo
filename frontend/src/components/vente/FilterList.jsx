          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-5">
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                {Array.isArray(quartiers) && quartiers.filter(q => q.ville?._id === villeSelected).map(q => (
            ...
            <div className="flex flex-col">
              ...
              <select className="w-full h-11 px-3 rounded-xl border border-white/20 bg-white/10 text-white outline-none" onChange={(e) => setType(e.target.value)}>
            ...
            <div className="flex flex-col">
              ...
              <input type="number" className="w-full h-11 px-4 rounded-xl border border-white/20 bg-white/10 text-white outline-none" onChange={(e) => setPrixMin(e.target.value)} />
            </div>

            {/* Prix Max */}
            <div className="flex flex-col">
              <label className="text-white/90 text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-1.5 ml-1">Prix Max</label>
              <input type="number" className="w-full h-11 px-4 rounded-xl border border-white/20 bg-white/10 text-white outline-none" onChange={(e) => setPrixMax(e.target.value)} />
            </div>
              ...
              <>
                {type === "maison" && (
                  <>
                    <div className="flex flex-col animate-in fade-in slide-in-from-top-2">
                      ...
                      <input type="number" className="w-full h-11 px-4 rounded-xl border border-white/20 bg-white/10 text-white outline-none" onChange={(e) => setNbreSalon(e.target.value)} />
                    </div>
                    <div className="flex flex-col animate-in fade-in slide-in-from-top-2">
                      <label className="text-white/90 text-[10px] font-bold uppercase mb-1.5 ml-1">Chambres</label>
                      <input type="number" className="w-full h-11 px-4 rounded-xl border border-white/20 bg-white/10 text-white outline-none" onChange={(e) => setNbreChambres(e.target.value)} />
                    </div>
                    <div className="flex flex-col animate-in fade-in slide-in-from-top-2">
                      <label className="text-white/90 text-[10px] font-bold uppercase mb-1.5 ml-1">Toilettes</label>
                      <input type="number" className="w-full h-11 px-4 rounded-xl border border-white/20 bg-white/10 text-white outline-none" onChange={(e) => setNombreDouche(e.target.value)} />
                    </div>
                  </>
                )}
                {(type === "maison" || type === "magasin" || type === "terrain" || type === "champ") && (
                  <div className="flex flex-col animate-in fade-in slide-in-from-top-2">
                    ...
                    <select className="w-full h-11 px-3 rounded-xl border border-white/20 bg-white/10 text-white outline-none" onChange={(e) => setDocumentTerrain(e.target.value)}>
                      <option value="tous" className="text-gray-900">Peu importe</option>
