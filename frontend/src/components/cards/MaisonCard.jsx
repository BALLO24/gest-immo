        ...
        <div className="p-4">
          ...
          <div className="flex justify-between text-gray-700 text-sm mb-4" aria-label="Caractéristiques de la maison">
            <span className="flex items-center gap-1">
              ...
              {maison.nombreSalons} {maison.nombreSalons > 1 ? 'Salons' : 'Salon'}
            </span>
            <span className="flex items-center gap-1">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm sm:text-lg font-bold text-maliOrange whitespace-nowrap" aria-label={maison.typeOffre === "location" ? "Prix du loyer" : "Prix de vente"}>
              {/* CORRIGÉ : "/ mois" s'affichait même pour une maison en
                  vente — n'a de sens qu'en location. */}
              {maison?.prix?.toLocaleString()} XOF{maison.typeOffre === "location" ? " / mois" : ""}
            </span>
            <div className="flex gap-2">
              ...
              <Link
                to={`/bien/${maison.slug || maison._id}`}
