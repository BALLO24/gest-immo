...
import { MapPin, Map, Locate, Sofa, Bed, Bath, Home, ChefHat, Store, Zap, Droplets, Motorbike, Wallet, MessageCircle,Phone, X } from "lucide-react";
...
export default function DetailsModalMaison({ item, onClose }) {
  ...
  const infos = [
    ...
    { Icon: Motorbike, label: "Magasin pour moto", value: item.motoParking, status: item.motoParking },
  ];
